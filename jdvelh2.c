...
int main ()
{
	...
	while (end != 1)
	{
		...
		if (choixChapitre == 1)
		{
			printf ("Bienvenue dans le chapitre [%d] 'The Debut'!\n", chapitre[0]);
		...
		if (choixChapitre == 2) 
		{
			printf ("Vous continuez une aventure inachevee en entrant dans le chapitre [%d] 'The Milieu' ! \n", chapitre[1]);
			printf ("Ou alors souhaitez-vous changer de chapitre ? \n 1. Oui\n 2. Non\n");
			scanf ("%d", &choixOuiNon);
			while (choixOuiNon !=1 && choixOuiNon !=2)
			{
		...
		if (choixChapitre == 3) 
		{
			printf ("Vous etes sur le point de finir l'histoire avec le chapitre [%d] 'The Fin' ! \n", chapitre[2]);
			printf ("Ou alors souhaitez-vous changer de chapitre ? \n 1. Oui\n 2. Non\n");
			scanf ("%d", &choixOuiNon);
			while (choixOuiNon !=1 && choixOuiNon !=2)
			{
